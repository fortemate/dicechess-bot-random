# Dice Chess Bot — Random Reference Bot — AI Agent Guidelines

## Architecture Overview
- **Domain**: Minimal, dependency-free TypeScript reference bot for playing Dice Chess via random-walk strategy.
