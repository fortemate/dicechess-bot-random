# Dice Chess Bot — Random Reference Bot (TypeScript)

[![CI](https://github.com/fortemate/dicechess-bot-random/actions/workflows/ci.yml/badge.svg)](https://github.com/fortemate/dicechess-bot-random/actions/workflows/ci.yml)
...
A complete, **runnable** Dice Chess random baseline bot in TypeScript with **zero runtime
dependencies** (built-in `fetch`). It mints an anonymous identity, challenges the
house sparring bot, and plays full games by walking a random path in the legal-move tree the server
...
[**Use this template**](https://github.com/fortemate/dicechess-bot-random/generate) → clone your copy → run:
...
```
minted anonymous identity bot:team:anon:random-bot-…
